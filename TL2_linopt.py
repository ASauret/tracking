...
b_qf1, db_qf1 = get_b_db('./qd2_field_int.dat', qf1sr, 0.0169)
b_qd2, db_qd2 = get_b_db('./qd2_field_int.dat', qd2sr, 0.16)
...
tl = at.load_lattice('present_TL2.mat', use='betamodel', periodicity=1)
...
#QF1 INJ
qf1 = at.Dipole('QF1_SR', qf1sr.Length, bending_angle=-0.00507068, k=1.74129177)
...
#obs.append(LocalOpticsObservable('SEXT', "dispersion", plane=1, target=0.0))
...
obs.append(LocalOpticsObservable(at.All, "beta", plane=1, target=75.0, bounds=(-numpy.inf, 0.0), statfun=numpy.amax))
obs.append(LocalOpticsObservable(at.All, "beta", plane=0, target=90.0, bounds=(-numpy.inf, 0.0), statfun=numpy.amax))
#obs.append(LocalOpticsObservable(at.All, "dispersion", plane=0, target=1.0, bounds=(-numpy.inf, 0.0), statfun=numpy.amax))
...
at.save_lattice(newtl2, './newtl2.mat')